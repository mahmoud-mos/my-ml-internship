...
|---|---:|---:|---:|---:|---:|
| decision_tree | 0.669 | 0.639 | 0.600 | 0.735 | 0.674 |
| logistic_regression | 0.674 | 0.659 | 0.676 | 0.721 | 0.670 |
| random_forest | 0.701 | 0.687 | 0.808 | 0.738 | 0.682 |
| baseline_rules | 0.488 | 0.576 | 0.320 | - | - |
...
- `days_with_impressions`: 0.1531
- `log_impressions_90d`: 0.1382
- `avg_position`: 0.1108
- `content_age_days`: 0.0935
- `word_count`: 0.0418
- `char_count`: 0.0381
- `age_tier_365+`: 0.0328
- `ctr`: 0.0312
- `position_tier_top_3`: 0.0301
- `scroll_rate`: 0.0286
